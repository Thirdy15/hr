        ...
        <div class="row justify-content-center">
            <div class="col-lg-7">
                <div class="d-grid gap-2">
                    <button class="btn btn-primary btn-sm" data-bs-toggle="modal" data-bs-target="#registrationModal">
    ...
    <div class="modal fade" id="registrationModal" tabindex="-1" aria-labelledby="registrationModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content bg-dark">
                <div class="modal-header border-bottom border-1 border-secondary">
                    <h5 class="modal-title text-light font-weight-light" id="registrationModalLabel">Create Admin Account</h5>
                ...
                <div class="modal-footer text-center border-top border-1 border-secondary">
