...
<html lang="en">
  <head>
    ...
    <style>
        ...
        .sb-sidenav-menu-heading, .sb-sidenav-footer {
            color: white; /* Sidenav text color */
        }
        .table th, .table td {
            color: white; /* Table text color */
        }
        .big {
            color: white; /* Big text color */
        }
        .text-dark {
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container mt-4">
                    <h2 class="text-center text-light">Your Evaluation Results</h2>
